...
public class Arco extends Lado {
	...
	public Arco(double peso, int tipo, Vértice v1, Vértice v2) {
		super(peso, tipo, v1, v2);
		// TODO Auto-generated constructor stub
	}
	// metodo que crea el arco
	public Arco CrearArco(double peso, int tipo, Vértice vi, Vértice vf) {
		Arco Arco=new Arco(peso, tipo, vi, vf);
		return Arco;
	}
	// retorna el vertice inicial
	public Vértice getExtremoInicial() {
		return this.vi;
	}
	// retorna el vertice final
	public Vértice getExtremoFinal() {
		return this.vf;
	}
	// si el vertice dado es inicial retorna true en otro caso false
	public boolean esExtremoInicial(Vértice v) {
	...
	public boolean esExtremoFinal(Vértice v) {
